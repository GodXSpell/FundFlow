    ...
    for (let i = 0; i < Math.min(cardsArray.length, 3); i++) {
        ...
        cardContainer.innerHTML = `
            ...
            <div class="wifiContactAndChip">
                <img src="assets/Images/Wifi ContactCard.png" alt="" style="width:100%;">
            </div>
    ...
    if (category && amount) {
        ...
        detailsDiv.innerHTML = `
                  <div class="IconAndPercentage">
                    <div class="BudgetIcon"><img src="assets/Images/Budget Card Image.png" style="width: 100%; height: auto;" alt=""></div>
